...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaticTranslation.original'
        db.add_column('datatrans_statictranslation', 'original', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StaticTranslation.original'
        db.delete_column('datatrans_statictranslation', 'original')
