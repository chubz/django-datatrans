...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TranslationCacheSettings.enable_static_translations'
        db.add_column('datatrans_translationcachesettings', 'enable_static_translations', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TranslationCacheSettings.enable_static_translations'
        db.delete_column('datatrans_translationcachesettings', 'enable_static_translations')
